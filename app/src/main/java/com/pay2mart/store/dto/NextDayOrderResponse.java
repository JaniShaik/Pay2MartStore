...
public class NextDayOrderResponse implements Parcelable {
    ...
    private ArrayList<NextDayOrder> orderDetailsArrayList = new ArrayList<>();
    ...
    public ArrayList<NextDayOrder> getOrderDetailsArrayList() {
        return orderDetailsArrayList;
    }

    public void setOrderDetailsArrayList(ArrayList<NextDayOrder> orderDetailsArrayList) {
        this.orderDetailsArrayList = orderDetailsArrayList;
    }

    protected NextDayOrderResponse(Parcel in) {
        ...
        orderDetailsArrayList = in.createTypedArrayList(NextDayOrder.CREATOR);
    }
    ...
    public static final Creator<NextDayOrderResponse> CREATOR = new Creator<NextDayOrderResponse>() {
        @Override
        public NextDayOrderResponse createFromParcel(Parcel in) {
            return new NextDayOrderResponse(in);
        }

        @Override
        public NextDayOrderResponse[] newArray(int size) {
            return new NextDayOrderResponse[size];
        }
    };
