...
public class NextDayOrder implements Parcelable {
    ...
    protected NextDayOrder(Parcel in) {
    ...
    public static final Creator<NextDayOrder> CREATOR = new Creator<NextDayOrder>() {
        @Override
        public NextDayOrder createFromParcel(Parcel in) {
            return new NextDayOrder(in);
        }

        @Override
        public NextDayOrder[] newArray(int size) {
            return new NextDayOrder[size];
        }
    };
