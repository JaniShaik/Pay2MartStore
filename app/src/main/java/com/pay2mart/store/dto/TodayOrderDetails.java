...
public class TodayOrderDetails implements Parcelable {
    ...
    protected TodayOrderDetails(Parcel in) {
    ...
    public static final Creator<TodayOrderDetails> CREATOR = new Creator<TodayOrderDetails>() {
        @Override
        public TodayOrderDetails createFromParcel(Parcel in) {
            return new TodayOrderDetails(in);
        }

        @Override
        public TodayOrderDetails[] newArray(int size) {
            return new TodayOrderDetails[size];
        }
    };
