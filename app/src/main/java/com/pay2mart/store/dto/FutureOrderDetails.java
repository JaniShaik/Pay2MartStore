...
public class FutureOrderDetails implements Parcelable {
    ...
    protected FutureOrderDetails(Parcel in) {
    ...
    public static final Creator<FutureOrderDetails> CREATOR = new Creator<FutureOrderDetails>() {
        @Override
        public FutureOrderDetails createFromParcel(Parcel in) {
            return new FutureOrderDetails(in);
        }

        @Override
        public FutureOrderDetails[] newArray(int size) {
            return new FutureOrderDetails[size];
        }
    };
}
