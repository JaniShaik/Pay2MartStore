...
public class CartInvoiceDetails implements Parcelable {
    ...
    protected CartInvoiceDetails(Parcel in) {
    ...
    public static final Creator<CartInvoiceDetails> CREATOR = new Creator<CartInvoiceDetails>() {
        @Override
        public CartInvoiceDetails createFromParcel(Parcel in) {
            return new CartInvoiceDetails(in);
        }

        @Override
        public CartInvoiceDetails[] newArray(int size) {
            return new CartInvoiceDetails[size];
        }
    };
